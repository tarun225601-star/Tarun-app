...
void main() async {
  ...
  runApp(const ViziaFeedApp());
}

class ViziaFeedApp extends StatelessWidget {
  const ViziaFeedApp({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Vizia Feed Marketplace',
...
class _FeedHomeScreenState extends State<FeedHomeScreen> {
  ...
  // Instagram फीड की तरह मल्टी-वेंडर डेटा (दुकान खुली/बंद और आइटम उपलब्ध/अनुपलब्ध के साथ)
  List<Map<String, dynamic>> feedVendors = [
    {
      'id': 'v1',
      'shop_name': 'ज्ञानी जी फ्रूट वाले',
      'isOpen': true, // दुकान खुली है या बंद
      ...
      'items': [
        ...
        {'name': 'Fresh Bananas (Dozen)', 'price': 60.0, 'available': false}, // उपलब्ध नहीं (Out of Stock)
      ]
    },
    {
      'id': 'v2',
      'shop_name': 'राजू फ्रूट & सब्जी भंडार',
      'isOpen': true,
      'deliveryInfo': 'Standard Delivery (30 mins) • Free Delivery above ₹200',
      'items': [
        {'name': 'Fresh Farm Potatoes (Aloo)', 'price': 30.0, 'available': true},
        {'name': 'Fresh Red Onions (Pyaj)', 'price': 40.0, 'available': true},
        {'name': 'Hybrid Tomatoes', 'price': 50.0, 'available': true},
      ]
    },
  ];
  ...
  void _saveAndLockConfig() async {
    if (_urlController.text.trim().isEmpty || _keyController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter Supabase credentials!')),
      );
      return;
    }
  ...
  void _addNewShop() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('New Shop Added to Feed! 🏪')));
  }
  ...
  void _addItemToShop() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Item published to feed successfully!')));
  }
  ...
  // Instagram की तरह कंटीन्यूअस स्क्रॉलिंग फीड (दुकानें और उनके नीचे उनके फल/सब्जियां)
      ...
      itemBuilder: (context, shopIndex) {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              // शॉप हेडर (नाम, ओपन/क्लोज स्टेटस और डिलीवरी जुगाड़)
              Container(
                ...
                child: Row(
                  ...
                  children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(isOpen ? 'OPEN' : 'CLOSED', style: const TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Colors.white)),
                              ),
                            ],
                          ),
                    ...
                    // एडमिन या ओनर के लिए दुकान ओपन/क्लोज करने का टॉगल बटन
                    Switch(
                      value: isOpen,
              ...
              // दुकान के नीचे सीधे दिखने वाले आइटम्स की लिस्ट (बिना क्लिक किए स्क्रॉल करते जाओ)
              Padding(
                padding: const EdgeInsets.all(12.0),
                child: items.isEmpty
                    ? const Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text('No items listed by this vendor yet.', style: TextStyle(color: Colors.grey, fontSize: 12)),
                      )
                    : ListView.builder(
                        shrinkWrap: true,
                          ...
                          return Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    // आइटम उपलब्ध है या नहीं इसका स्टेटस बटन / टॉगल
                                    InkWell(
                                      onTap: () {
                                        setState(() {
                                    ...
                                    const SizedBox(width: 8),
                                    // कार्ट में जोड़ने का बटन (अगर दुकान खुली है और आइटम उपलब्ध है तभी काम करेगा)
                                    ElevatedButton(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Navigator.pop(context);
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Order placed with delivery partner successfully! 🛵')),
                        );
                      },
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Register New Shop (Vendor)', style: TextStyle(color: Color(0xFF38BDF8), fontWeight: FontWeight.bold, fontSize: 13)),
                const SizedBox(height: 10),
                TextField(controller: _shopNameController, decoration: const InputDecoration(hintText: 'Shop Name e.g. ज्ञानी जी फ्रूट वाले', filled: true, fillColor: Color(0xFF0F172A))),
                const SizedBox(height: 10),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF0284C7)),
                  onPressed: _addNewShop,
                  child: const Text('Add Shop to Feed'),
                ),
              ],
            ),
          ),
          const SizedBox(height: 16),
          // किसी भी दुकान के अंदर आइटम जोड़ें
          Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(color: const Color(0xFF1E293B), borderRadius: BorderRadius.circular(12)),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Add Item to Shop Feed', style: TextStyle(color: Color(0xFF38BDF8), fontWeight: FontWeight.bold, fontSize: 13)),
                const SizedBox(height: 10),
                ...
                const SizedBox(height: 10),
                TextField(controller: _itemNameController, decoration: const InputDecoration(hintText: 'Item Name (e.g. Apple)', filled: true, fillColor: Color(0xFF0F172A))),
                const SizedBox(height: 10),
                ...
                ElevatedButton(
                  ...
                  child: const Text('Publish Item to Feed'),
                ),
              ],
            ),
          ),
